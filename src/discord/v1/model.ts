...
export enum ChannelData_ChannelType {
  UNKNOWN = 0,
  GUILD_TEXT = 1,
  DM = 2,
  GUILD_VOICE = 3,
...
export function channelData_ChannelTypeFromJSON(
  object: any
...
export function channelData_ChannelTypeToJSON(
  object: ChannelData_ChannelType
): string {
  switch (object) {
...
export enum ChannelData_ChannelPermissionOverwriteData_ChannelPermissionOverwriteType {
  UNKNOWN = 0,
  ROLE = 1,
  MEMBER = 2,
}

export function channelData_ChannelPermissionOverwriteData_ChannelPermissionOverwriteTypeFromJSON(
  object: any
...
export function channelData_ChannelPermissionOverwriteData_ChannelPermissionOverwriteTypeToJSON(
  object: ChannelData_ChannelPermissionOverwriteData_ChannelPermissionOverwriteType
): string {
  switch (object) {
...
export enum MessageData_MessageEmbedData_MessageEmbedType {
  UNKNOWN = 0,
  RICH = 1,
  IMAGE = 2,
  VIDEO = 3,
...
export function messageData_MessageEmbedData_MessageEmbedTypeFromJSON(
  object: any
): MessageData_MessageEmbedData_MessageEmbedType {
  switch (object) {
    case 0:
    case "UNKNOWN":
...
export function messageData_MessageEmbedData_MessageEmbedTypeToJSON(
  object: MessageData_MessageEmbedData_MessageEmbedType
): string {
  switch (object) {
...
export enum PresenceData_OnlineStatus {
  UNKNOWN = 0,
  ONLINE = 1,
  IDLE = 2,
  DND = 3,
...
export function presenceData_OnlineStatusFromJSON(
  object: any
...
export function presenceData_OnlineStatusToJSON(
  object: PresenceData_OnlineStatus
): string {
  switch (object) {
...
export interface PresenceData_PresenceActivityData {
  ...
  timestamps:
    | PresenceData_PresenceActivityData_PresenceActivityTimestampsData
    | undefined;
  applicationId: string;
  details: string;
  state: string;
  emoji:
    | PresenceData_PresenceActivityData_PresenceActivityEmojiData
    | undefined;
  party:
    | PresenceData_PresenceActivityData_PresenceActivityPartyData
    | undefined;
  assets:
    | PresenceData_PresenceActivityData_PresenceActivityAssetsData
    | undefined;
  secrets:
    | PresenceData_PresenceActivityData_PresenceActivitySecretsData
    | undefined;
  instance: boolean;
  flags: number;
}

export enum PresenceData_PresenceActivityData_ActivityType {
  UNKNOWN = 0,
  DEFAULT = 1,
  STREAMING = 2,
  LISTENING = 3,
...
export function presenceData_PresenceActivityData_ActivityTypeFromJSON(
  object: any
...
export function presenceData_PresenceActivityData_ActivityTypeToJSON(
  object: PresenceData_PresenceActivityData_ActivityType
): string {
  switch (object) {
...
export enum WebhookData_WebhookType {
  INCOMING = 0,
  CHANNEL_FOLLOWER = 1,
}

export function webhookData_WebhookTypeFromJSON(
  object: any
): WebhookData_WebhookType {
  switch (object) {
    case 0:
    case "INCOMING":
...
export function webhookData_WebhookTypeToJSON(
  object: WebhookData_WebhookType
): string {
  switch (object) {
...
export enum InviteData_InviteTargetUserType {
  UNKNOWN = 0,
  STREAM = 1,
}

export function inviteData_InviteTargetUserTypeFromJSON(
  object: any
...
export function inviteData_InviteTargetUserTypeToJSON(
  object: InviteData_InviteTargetUserType
): string {
  switch (object) {
...
const baseSnowflakeValue: object = {
  $type: "pylon.discord.v1.model.SnowflakeValue",
  value: "0",
};

export const SnowflakeValue = {
  $type: "pylon.discord.v1.model.SnowflakeValue" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SnowflakeValue {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseSnowflakeValue } as SnowflakeValue;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.value = longToString(reader.fixed64() as Long);
          break;
        default:
...
const baseSnowflakeListValue: object = {
  $type: "pylon.discord.v1.model.SnowflakeListValue",
  values: "0",
};

export const SnowflakeListValue = {
  $type: "pylon.discord.v1.model.SnowflakeListValue" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SnowflakeListValue {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseSnowflakeListValue } as SnowflakeListValue;
    message.values = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          if ((tag & 7) === 2) {
            ...
            while (reader.pos < end2) {
              message.values.push(longToString(reader.fixed64() as Long));
            }
          } else {
            message.values.push(longToString(reader.fixed64() as Long));
          }
...
const basePermissionsValue: object = {
  $type: "pylon.discord.v1.model.PermissionsValue",
  value: "0",
};

export const PermissionsValue = {
  $type: "pylon.discord.v1.model.PermissionsValue" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PermissionsValue {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...basePermissionsValue } as PermissionsValue;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const GuildData = {
  $type: "pylon.discord.v1.model.GuildData" as const,
  ...
  encode(
    ...
    if (message.icon !== undefined) {
      StringValue.encode(
        { $type: "google.protobuf.StringValue", value: message.icon! },
    ...
    if (message.joinedAt !== undefined) {
      Timestamp.encode(
        toTimestamp(message.joinedAt),
        writer.uint32(58).fork()
      ).ldelim();
    }
    if (message.splash !== undefined) {
      StringValue.encode(
        { $type: "google.protobuf.StringValue", value: message.splash! },
    ...
    if (message.vanityUrlCode !== undefined) {
      StringValue.encode(
        { $type: "google.protobuf.StringValue", value: message.vanityUrlCode! },
        writer.uint32(162).fork()
      ).ldelim();
    }
    if (message.description !== undefined) {
      StringValue.encode(
        { $type: "google.protobuf.StringValue", value: message.description! },
        writer.uint32(170).fork()
      ).ldelim();
    }
    if (message.banner !== undefined) {
      StringValue.encode(
        { $type: "google.protobuf.StringValue", value: message.banner! },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GuildData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseGuildData } as GuildData;
    message.features = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break;
        case 7:
          message.joinedAt = fromTimestamp(
        ...
        case 8:
          ...
          break;
        case 9:
          message.discoverySplash = StringValue.decode(
            reader,
            reader.uint32()
          ).value;
          break;
        ...
        case 17:
          ...
          break;
        case 18:
          message.widgetChannelId = SnowflakeValue.decode(
            reader,
            reader.uint32()
          );
          break;
        case 19:
          ...
          break;
        case 20:
          message.vanityUrlCode = StringValue.decode(
            reader,
            reader.uint32()
          ).value;
          break;
  ...
  fromJSON(object: any): GuildData {
    ...
    if (
      object.discoverySplash !== undefined &&
    ...
    if (
      object.widgetChannelId !== undefined &&
    ...
    if (
      object.premiumSubscriptionCount !== undefined &&
      object.premiumSubscriptionCount !== null
    ) {
      message.premiumSubscriptionCount = Number(
        object.premiumSubscriptionCount
      );
    }
  ...
  fromPartial(object: DeepPartial<GuildData>): GuildData {
    ...
    if (
      ...
      message.widgetChannelId = SnowflakeValue.fromPartial(
        object.widgetChannelId
      );
    }
    if (
      object.systemChannelId !== undefined &&
...
export const ChannelData = {
  $type: "pylon.discord.v1.model.ChannelData" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChannelData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseChannelData } as ChannelData;
...
const baseChannelData_ChannelPermissionOverwriteData: object = {
  $type: "pylon.discord.v1.model.ChannelData.ChannelPermissionOverwriteData",
  id: "0",
  type: 0,
  allow: "0",
...
export const ChannelData_ChannelPermissionOverwriteData = {
  $type: "pylon.discord.v1.model.ChannelData.ChannelPermissionOverwriteData" as const,

  encode(
    message: ChannelData_ChannelPermissionOverwriteData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.id !== "0") {
      writer.uint32(9).fixed64(message.id);
  ...
  decode(
    ...
    } as ChannelData_ChannelPermissionOverwriteData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<ChannelData_ChannelPermissionOverwriteData>
  ): ChannelData_ChannelPermissionOverwriteData {
    const message = {
      ...baseChannelData_ChannelPermissionOverwriteData,
    } as ChannelData_ChannelPermissionOverwriteData;
...
messageTypeRegistry.set(
  ChannelData_ChannelPermissionOverwriteData.$type,
  ChannelData_ChannelPermissionOverwriteData
);
...
export const UserData = {
  $type: "pylon.discord.v1.model.UserData" as const,
  ...
  encode(
    ...
    if (message.avatar !== undefined) {
      StringValue.encode(
        { $type: "google.protobuf.StringValue", value: message.avatar! },
        writer.uint32(26).fork()
      ).ldelim();
    }
...
export const MemberData = {
  $type: "pylon.discord.v1.model.MemberData" as const,
  ...
  encode(
    ...
    if (message.premiumSince !== undefined) {
      Timestamp.encode(
        toTimestamp(message.premiumSince),
        writer.uint32(58).fork()
      ).ldelim();
    }
    ...
    if (message.pending !== undefined) {
      BoolValue.encode(
        { $type: "google.protobuf.BoolValue", value: message.pending! },
        writer.uint32(74).fork()
      ).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MemberData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMemberData } as MemberData;
    message.roles = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        ...
        case 5:
          if ((tag & 7) === 2) {
            const end2 = reader.uint32() + reader.pos;
            while (reader.pos < end2) {
              message.roles.push(longToString(reader.fixed64() as Long));
            }
          } else {
            message.roles.push(longToString(reader.fixed64() as Long));
          }
        ...
        case 6:
          ...
          break;
        case 7:
          message.premiumSince = fromTimestamp(
            Timestamp.decode(reader, reader.uint32())
          );
          break;
        case 8:
          message.permissions = longToString(reader.uint64() as Long);
          break;
        case 9:
...
export const RoleData = {
  $type: "pylon.discord.v1.model.RoleData" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RoleData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseRoleData } as RoleData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const EmojiData = {
  $type: "pylon.discord.v1.model.EmojiData" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): EmojiData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseEmojiData } as EmojiData;
    message.roles = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
const baseVoiceStateData: object = {
  $type: "pylon.discord.v1.model.VoiceStateData",
  guildId: "0",
  selfMute: false,
  selfDeaf: false,
...
export const VoiceStateData = {
  $type: "pylon.discord.v1.model.VoiceStateData" as const,
  ...
  encode(
    ...
    if (message.sessionId !== undefined) {
      StringValue.encode(
        { $type: "google.protobuf.StringValue", value: message.sessionId! },
        writer.uint32(34).fork()
      ).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): VoiceStateData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseVoiceStateData } as VoiceStateData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const MessageData = {
  $type: "pylon.discord.v1.model.MessageData" as const,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 17:
          ...
          break;
        case 18:
          message.activity = MessageData_MessageActivityData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 19:
          message.application = MessageData_MessageApplicationData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 20:
          message.messageReference = MessageData_MessageReferenceData.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): MessageData {
    ...
    if (
      ...
      for (const e of object.mentionChannels) {
        message.mentionChannels.push(
          MessageData_MessageMentionChannelData.fromJSON(e)
        );
      }
    }
    ...
    if (object.activity !== undefined && object.activity !== null) {
      message.activity = MessageData_MessageActivityData.fromJSON(
        object.activity
      );
    }
    if (object.application !== undefined && object.application !== null) {
      message.application = MessageData_MessageApplicationData.fromJSON(
        object.application
      );
    }
    if (
      ...
      message.messageReference = MessageData_MessageReferenceData.fromJSON(
  ...
  toJSON(message: MessageData): unknown {
    ...
    if (message.embeds) {
      obj.embeds = message.embeds.map((e) =>
    ...
    if (message.mentionChannels) {
      obj.mentionChannels = message.mentionChannels.map((e) =>
  ...
  fromPartial(object: DeepPartial<MessageData>): MessageData {
    ...
    if (object.attachments !== undefined && object.attachments !== null) {
      for (const e of object.attachments) {
        message.attachments.push(
          MessageData_MessageAttachmentData.fromPartial(e)
        );
      }
    }
    if (object.embeds !== undefined && object.embeds !== null) {
    ...
    if (object.activity !== undefined && object.activity !== null) {
      message.activity = MessageData_MessageActivityData.fromPartial(
        object.activity
      );
    }
    if (object.application !== undefined && object.application !== null) {
      message.application = MessageData_MessageApplicationData.fromPartial(
        object.application
      );
    }
    if (
      ...
      message.messageReference = MessageData_MessageReferenceData.fromPartial(
        object.messageReference
      );
    }
    if (object.author !== undefined && object.author !== null) {
...
const baseMessageData_MessageAttachmentData: object = {
  $type: "pylon.discord.v1.model.MessageData.MessageAttachmentData",
  id: "0",
  filename: "",
  size: "0",
...
export const MessageData_MessageAttachmentData = {
  $type: "pylon.discord.v1.model.MessageData.MessageAttachmentData" as const,

  encode(
    message: MessageData_MessageAttachmentData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.id !== "0") {
      writer.uint32(9).fixed64(message.id);
  ...
  decode(
    ...
    } as MessageData_MessageAttachmentData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 5:
          ...
          break;
        case 6:
          message.width = longToString(reader.uint64() as Long);
          break;
        case 7:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageAttachmentData>
  ): MessageData_MessageAttachmentData {
    const message = {
      ...baseMessageData_MessageAttachmentData,
    } as MessageData_MessageAttachmentData;
...
messageTypeRegistry.set(
  MessageData_MessageAttachmentData.$type,
  MessageData_MessageAttachmentData
);

const baseMessageData_MessageMentionData: object = {
  $type: "pylon.discord.v1.model.MessageData.MessageMentionData",
  id: "0",
  username: "",
  avatar: "",
...
export const MessageData_MessageMentionData = {
  $type: "pylon.discord.v1.model.MessageData.MessageMentionData" as const,

  encode(
    message: MessageData_MessageMentionData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.id !== "0") {
      writer.uint32(9).fixed64(message.id);
  ...
  decode(
    ...
    } as MessageData_MessageMentionData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageMentionData>
  ): MessageData_MessageMentionData {
    const message = {
      ...baseMessageData_MessageMentionData,
    } as MessageData_MessageMentionData;
...
messageTypeRegistry.set(
  MessageData_MessageMentionData.$type,
  MessageData_MessageMentionData
);

const baseMessageData_MessageReactionData: object = {
  $type: "pylon.discord.v1.model.MessageData.MessageReactionData",
  count: 0,
  me: false,
};
...
export const MessageData_MessageReactionData = {
  $type: "pylon.discord.v1.model.MessageData.MessageReactionData" as const,

  encode(
    message: MessageData_MessageReactionData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.count !== 0) {
  ...
  decode(
    ...
    } as MessageData_MessageReactionData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageReactionData>
  ): MessageData_MessageReactionData {
    const message = {
      ...baseMessageData_MessageReactionData,
    } as MessageData_MessageReactionData;
...
messageTypeRegistry.set(
  MessageData_MessageReactionData.$type,
  MessageData_MessageReactionData
);

const baseMessageData_MessageReactionEmojiData: object = {
  $type: "pylon.discord.v1.model.MessageData.MessageReactionEmojiData",
  id: "0",
  name: "",
  animated: false,
...
export const MessageData_MessageReactionEmojiData = {
  $type: "pylon.discord.v1.model.MessageData.MessageReactionEmojiData" as const,

  encode(
    message: MessageData_MessageReactionEmojiData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.id !== "0") {
      writer.uint32(9).fixed64(message.id);
  ...
  decode(
    ...
    } as MessageData_MessageReactionEmojiData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageReactionEmojiData>
  ): MessageData_MessageReactionEmojiData {
    const message = {
      ...baseMessageData_MessageReactionEmojiData,
    } as MessageData_MessageReactionEmojiData;
...
messageTypeRegistry.set(
  MessageData_MessageReactionEmojiData.$type,
  MessageData_MessageReactionEmojiData
);

const baseMessageData_MessageApplicationData: object = {
  $type: "pylon.discord.v1.model.MessageData.MessageApplicationData",
  id: "0",
  coverImage: "",
  description: "",
...
export const MessageData_MessageApplicationData = {
  $type: "pylon.discord.v1.model.MessageData.MessageApplicationData" as const,

  encode(
    message: MessageData_MessageApplicationData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.id !== "0") {
      writer.uint32(9).fixed64(message.id);
  ...
  decode(
    ...
    } as MessageData_MessageApplicationData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageApplicationData>
  ): MessageData_MessageApplicationData {
    const message = {
      ...baseMessageData_MessageApplicationData,
    } as MessageData_MessageApplicationData;
...
messageTypeRegistry.set(
  MessageData_MessageApplicationData.$type,
  MessageData_MessageApplicationData
);

const baseMessageData_MessageReferenceData: object = {
  $type: "pylon.discord.v1.model.MessageData.MessageReferenceData",
  messageId: "0",
  channelId: "0",
  guildId: "0",
...
export const MessageData_MessageReferenceData = {
  $type: "pylon.discord.v1.model.MessageData.MessageReferenceData" as const,

  encode(
    message: MessageData_MessageReferenceData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
  ...
  decode(
    ...
    } as MessageData_MessageReferenceData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageReferenceData>
  ): MessageData_MessageReferenceData {
    const message = {
      ...baseMessageData_MessageReferenceData,
    } as MessageData_MessageReferenceData;
...
messageTypeRegistry.set(
  MessageData_MessageReferenceData.$type,
  MessageData_MessageReferenceData
);

const baseMessageData_MessageActivityData: object = {
  $type: "pylon.discord.v1.model.MessageData.MessageActivityData",
  type: 0,
  partyId: "",
};
...
export const MessageData_MessageActivityData = {
  $type: "pylon.discord.v1.model.MessageData.MessageActivityData" as const,

  encode(
    message: MessageData_MessageActivityData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.type !== 0) {
  ...
  decode(
    ...
    } as MessageData_MessageActivityData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageActivityData>
  ): MessageData_MessageActivityData {
    const message = {
      ...baseMessageData_MessageActivityData,
    } as MessageData_MessageActivityData;
...
messageTypeRegistry.set(
  MessageData_MessageActivityData.$type,
  MessageData_MessageActivityData
);

const baseMessageData_MessageMentionChannelData: object = {
  $type: "pylon.discord.v1.model.MessageData.MessageMentionChannelData",
  id: "0",
  guildId: "0",
  type: 0,
...
export const MessageData_MessageMentionChannelData = {
  $type: "pylon.discord.v1.model.MessageData.MessageMentionChannelData" as const,

  encode(
    message: MessageData_MessageMentionChannelData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.id !== "0") {
      writer.uint32(9).fixed64(message.id);
  ...
  decode(
    ...
    } as MessageData_MessageMentionChannelData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageMentionChannelData>
  ): MessageData_MessageMentionChannelData {
    const message = {
      ...baseMessageData_MessageMentionChannelData,
    } as MessageData_MessageMentionChannelData;
...
messageTypeRegistry.set(
  MessageData_MessageMentionChannelData.$type,
  MessageData_MessageMentionChannelData
);

const baseMessageData_MessageEmbedData: object = {
  $type: "pylon.discord.v1.model.MessageData.MessageEmbedData",
  title: "",
  type: 0,
  description: "",
...
export const MessageData_MessageEmbedData = {
  $type: "pylon.discord.v1.model.MessageData.MessageEmbedData" as const,

  encode(
    message: MessageData_MessageEmbedData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.title !== "") {
    ...
    if (message.footer !== undefined) {
      MessageData_MessageEmbedData_MessageEmbedFooterData.encode(
        message.footer,
        writer.uint32(58).fork()
      ).ldelim();
    }
    if (message.image !== undefined) {
      MessageData_MessageEmbedData_MessageEmbedImageData.encode(
        message.image,
        writer.uint32(66).fork()
      ).ldelim();
    }
    if (message.thumbnail !== undefined) {
      MessageData_MessageEmbedData_MessageEmbedThumbnailData.encode(
        message.thumbnail,
        writer.uint32(74).fork()
      ).ldelim();
    }
    if (message.video !== undefined) {
      MessageData_MessageEmbedData_MessageEmbedVideoData.encode(
        message.video,
        writer.uint32(82).fork()
      ).ldelim();
    }
    if (message.provider !== undefined) {
      MessageData_MessageEmbedData_MessageEmbedProviderData.encode(
        message.provider,
        writer.uint32(90).fork()
      ).ldelim();
    }
    if (message.author !== undefined) {
      MessageData_MessageEmbedData_MessageEmbedAuthorData.encode(
        message.author,
        writer.uint32(98).fork()
      ).ldelim();
    }
    for (const v of message.fields) {
      MessageData_MessageEmbedData_MessageEmbedFieldData.encode(
        v!,
        writer.uint32(106).fork()
      ).ldelim();
    }
  ...
  decode(
    ...
    } as MessageData_MessageEmbedData;
    message.fields = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break;
        case 7:
          message.footer = MessageData_MessageEmbedData_MessageEmbedFooterData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 8:
          message.image = MessageData_MessageEmbedData_MessageEmbedImageData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 9:
          message.thumbnail = MessageData_MessageEmbedData_MessageEmbedThumbnailData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 10:
          message.video = MessageData_MessageEmbedData_MessageEmbedVideoData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 11:
          message.provider = MessageData_MessageEmbedData_MessageEmbedProviderData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 12:
          message.author = MessageData_MessageEmbedData_MessageEmbedAuthorData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 13:
          message.fields.push(
            MessageData_MessageEmbedData_MessageEmbedFieldData.decode(
              reader,
              reader.uint32()
            )
          );
  ...
  fromJSON(object: any): MessageData_MessageEmbedData {
    ...
    if (object.type !== undefined && object.type !== null) {
      message.type = messageData_MessageEmbedData_MessageEmbedTypeFromJSON(
        object.type
      );
    }
    if (object.description !== undefined && object.description !== null) {
    ...
    if (object.footer !== undefined && object.footer !== null) {
      message.footer = MessageData_MessageEmbedData_MessageEmbedFooterData.fromJSON(
        object.footer
      );
    }
    if (object.image !== undefined && object.image !== null) {
      message.image = MessageData_MessageEmbedData_MessageEmbedImageData.fromJSON(
        object.image
      );
    }
    if (object.thumbnail !== undefined && object.thumbnail !== null) {
      message.thumbnail = MessageData_MessageEmbedData_MessageEmbedThumbnailData.fromJSON(
        object.thumbnail
      );
    }
    if (object.video !== undefined && object.video !== null) {
      message.video = MessageData_MessageEmbedData_MessageEmbedVideoData.fromJSON(
        object.video
      );
    }
    if (object.provider !== undefined && object.provider !== null) {
      message.provider = MessageData_MessageEmbedData_MessageEmbedProviderData.fromJSON(
        object.provider
      );
    }
    if (object.author !== undefined && object.author !== null) {
      message.author = MessageData_MessageEmbedData_MessageEmbedAuthorData.fromJSON(
        object.author
      );
    }
    if (object.fields !== undefined && object.fields !== null) {
      for (const e of object.fields) {
        message.fields.push(
          MessageData_MessageEmbedData_MessageEmbedFieldData.fromJSON(e)
        );
      }
    }
    return message;
  ...
  toJSON(message: MessageData_MessageEmbedData): unknown {
    ...
    message.type !== undefined &&
      (obj.type = messageData_MessageEmbedData_MessageEmbedTypeToJSON(
        message.type
      ));
    message.description !== undefined &&
      (obj.description = message.description);
    ...
    message.footer !== undefined &&
      (obj.footer = message.footer
        ? MessageData_MessageEmbedData_MessageEmbedFooterData.toJSON(
            message.footer
          )
        : undefined);
    message.image !== undefined &&
      (obj.image = message.image
        ? MessageData_MessageEmbedData_MessageEmbedImageData.toJSON(
            message.image
          )
        : undefined);
    message.thumbnail !== undefined &&
      (obj.thumbnail = message.thumbnail
        ? MessageData_MessageEmbedData_MessageEmbedThumbnailData.toJSON(
            message.thumbnail
          )
        : undefined);
    message.video !== undefined &&
      (obj.video = message.video
        ? MessageData_MessageEmbedData_MessageEmbedVideoData.toJSON(
            message.video
          )
        : undefined);
    message.provider !== undefined &&
      (obj.provider = message.provider
        ? MessageData_MessageEmbedData_MessageEmbedProviderData.toJSON(
            message.provider
          )
        : undefined);
    message.author !== undefined &&
      (obj.author = message.author
        ? MessageData_MessageEmbedData_MessageEmbedAuthorData.toJSON(
            message.author
          )
        : undefined);
    if (message.fields) {
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageEmbedData>
  ): MessageData_MessageEmbedData {
    const message = {
      ...baseMessageData_MessageEmbedData,
    } as MessageData_MessageEmbedData;
    ...
    if (object.footer !== undefined && object.footer !== null) {
      message.footer = MessageData_MessageEmbedData_MessageEmbedFooterData.fromPartial(
        object.footer
      );
    }
    if (object.image !== undefined && object.image !== null) {
      message.image = MessageData_MessageEmbedData_MessageEmbedImageData.fromPartial(
        object.image
      );
    }
    if (object.thumbnail !== undefined && object.thumbnail !== null) {
      message.thumbnail = MessageData_MessageEmbedData_MessageEmbedThumbnailData.fromPartial(
        object.thumbnail
      );
    }
    if (object.video !== undefined && object.video !== null) {
      message.video = MessageData_MessageEmbedData_MessageEmbedVideoData.fromPartial(
        object.video
      );
    }
    if (object.provider !== undefined && object.provider !== null) {
      message.provider = MessageData_MessageEmbedData_MessageEmbedProviderData.fromPartial(
        object.provider
      );
    }
    if (object.author !== undefined && object.author !== null) {
      message.author = MessageData_MessageEmbedData_MessageEmbedAuthorData.fromPartial(
        object.author
      );
    }
    if (object.fields !== undefined && object.fields !== null) {
      for (const e of object.fields) {
        message.fields.push(
          MessageData_MessageEmbedData_MessageEmbedFieldData.fromPartial(e)
        );
      }
    }
    return message;
...
messageTypeRegistry.set(
  MessageData_MessageEmbedData.$type,
  MessageData_MessageEmbedData
);

const baseMessageData_MessageEmbedData_MessageEmbedFooterData: object = {
  $type:
    "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedFooterData",
  text: "",
  iconUrl: "",
  proxyIconUrl: "",
};
...
export const MessageData_MessageEmbedData_MessageEmbedFooterData = {
  $type: "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedFooterData" as const,

  encode(
    message: MessageData_MessageEmbedData_MessageEmbedFooterData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.text !== "") {
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): MessageData_MessageEmbedData_MessageEmbedFooterData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedFooterData,
    } as MessageData_MessageEmbedData_MessageEmbedFooterData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageEmbedData_MessageEmbedFooterData>
  ): MessageData_MessageEmbedData_MessageEmbedFooterData {
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedFooterData,
    } as MessageData_MessageEmbedData_MessageEmbedFooterData;
...
messageTypeRegistry.set(
  MessageData_MessageEmbedData_MessageEmbedFooterData.$type,
  MessageData_MessageEmbedData_MessageEmbedFooterData
);

const baseMessageData_MessageEmbedData_MessageEmbedImageData: object = {
  $type:
    "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedImageData",
  url: "",
  width: 0,
  height: 0,
};
...
export const MessageData_MessageEmbedData_MessageEmbedImageData = {
  $type: "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedImageData" as const,

  encode(
    message: MessageData_MessageEmbedData_MessageEmbedImageData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.url !== "") {
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): MessageData_MessageEmbedData_MessageEmbedImageData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedImageData,
    } as MessageData_MessageEmbedData_MessageEmbedImageData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageEmbedData_MessageEmbedImageData>
  ): MessageData_MessageEmbedData_MessageEmbedImageData {
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedImageData,
    } as MessageData_MessageEmbedData_MessageEmbedImageData;
...
messageTypeRegistry.set(
  MessageData_MessageEmbedData_MessageEmbedImageData.$type,
  MessageData_MessageEmbedData_MessageEmbedImageData
);

const baseMessageData_MessageEmbedData_MessageEmbedThumbnailData: object = {
  $type:
    "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedThumbnailData",
  url: "",
  proxyUrl: "",
  width: 0,
  height: 0,
...
export const MessageData_MessageEmbedData_MessageEmbedThumbnailData = {
  $type: "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedThumbnailData" as const,

  encode(
    message: MessageData_MessageEmbedData_MessageEmbedThumbnailData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.url !== "") {
      writer.uint32(10).string(message.url);
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): MessageData_MessageEmbedData_MessageEmbedThumbnailData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedThumbnailData,
    } as MessageData_MessageEmbedData_MessageEmbedThumbnailData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageEmbedData_MessageEmbedThumbnailData>
  ): MessageData_MessageEmbedData_MessageEmbedThumbnailData {
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedThumbnailData,
    } as MessageData_MessageEmbedData_MessageEmbedThumbnailData;
...
messageTypeRegistry.set(
  MessageData_MessageEmbedData_MessageEmbedThumbnailData.$type,
  MessageData_MessageEmbedData_MessageEmbedThumbnailData
);

const baseMessageData_MessageEmbedData_MessageEmbedVideoData: object = {
  $type:
    "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedVideoData",
  url: "",
  width: 0,
  height: 0,
};
...
export const MessageData_MessageEmbedData_MessageEmbedVideoData = {
  $type: "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedVideoData" as const,

  encode(
    message: MessageData_MessageEmbedData_MessageEmbedVideoData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.url !== "") {
      writer.uint32(10).string(message.url);
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): MessageData_MessageEmbedData_MessageEmbedVideoData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedVideoData,
    } as MessageData_MessageEmbedData_MessageEmbedVideoData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageEmbedData_MessageEmbedVideoData>
  ): MessageData_MessageEmbedData_MessageEmbedVideoData {
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedVideoData,
    } as MessageData_MessageEmbedData_MessageEmbedVideoData;
...
messageTypeRegistry.set(
  MessageData_MessageEmbedData_MessageEmbedVideoData.$type,
  MessageData_MessageEmbedData_MessageEmbedVideoData
);

const baseMessageData_MessageEmbedData_MessageEmbedProviderData: object = {
  $type:
    "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedProviderData",
  name: "",
  url: "",
};

export const MessageData_MessageEmbedData_MessageEmbedProviderData = {
  $type: "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedProviderData" as const,

  encode(
    message: MessageData_MessageEmbedData_MessageEmbedProviderData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.name !== "") {
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): MessageData_MessageEmbedData_MessageEmbedProviderData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedProviderData,
    } as MessageData_MessageEmbedData_MessageEmbedProviderData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageEmbedData_MessageEmbedProviderData>
  ): MessageData_MessageEmbedData_MessageEmbedProviderData {
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedProviderData,
    } as MessageData_MessageEmbedData_MessageEmbedProviderData;
...
messageTypeRegistry.set(
  MessageData_MessageEmbedData_MessageEmbedProviderData.$type,
  MessageData_MessageEmbedData_MessageEmbedProviderData
);

const baseMessageData_MessageEmbedData_MessageEmbedAuthorData: object = {
  $type:
    "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedAuthorData",
  name: "",
  url: "",
  iconUrl: "",
  proxyIconUrl: "",
...
export const MessageData_MessageEmbedData_MessageEmbedAuthorData = {
  $type: "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedAuthorData" as const,

  encode(
    message: MessageData_MessageEmbedData_MessageEmbedAuthorData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): MessageData_MessageEmbedData_MessageEmbedAuthorData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedAuthorData,
    } as MessageData_MessageEmbedData_MessageEmbedAuthorData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageEmbedData_MessageEmbedAuthorData>
  ): MessageData_MessageEmbedData_MessageEmbedAuthorData {
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedAuthorData,
    } as MessageData_MessageEmbedData_MessageEmbedAuthorData;
...
messageTypeRegistry.set(
  MessageData_MessageEmbedData_MessageEmbedAuthorData.$type,
  MessageData_MessageEmbedData_MessageEmbedAuthorData
);

const baseMessageData_MessageEmbedData_MessageEmbedFieldData: object = {
  $type:
    "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedFieldData",
  name: "",
  value: "",
  inline: false,
};
...
export const MessageData_MessageEmbedData_MessageEmbedFieldData = {
  $type: "pylon.discord.v1.model.MessageData.MessageEmbedData.MessageEmbedFieldData" as const,

  encode(
    message: MessageData_MessageEmbedData_MessageEmbedFieldData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): MessageData_MessageEmbedData_MessageEmbedFieldData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedFieldData,
    } as MessageData_MessageEmbedData_MessageEmbedFieldData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MessageData_MessageEmbedData_MessageEmbedFieldData>
  ): MessageData_MessageEmbedData_MessageEmbedFieldData {
    const message = {
      ...baseMessageData_MessageEmbedData_MessageEmbedFieldData,
    } as MessageData_MessageEmbedData_MessageEmbedFieldData;
...
messageTypeRegistry.set(
  MessageData_MessageEmbedData_MessageEmbedFieldData.$type,
  MessageData_MessageEmbedData_MessageEmbedFieldData
);

const basePresenceData: object = {
  $type: "pylon.discord.v1.model.PresenceData",
  guildId: "0",
  status: 0,
};
...
export const PresenceData = {
  $type: "pylon.discord.v1.model.PresenceData" as const,
  ...
  encode(
    ...
    if (message.clientStatus !== undefined) {
      PresenceData_PresenceClientStatusData.encode(
        message.clientStatus,
        writer.uint32(42).fork()
      ).ldelim();
    }
    for (const v of message.activities) {
      PresenceData_PresenceActivityData.encode(
        v!,
        writer.uint32(50).fork()
      ).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PresenceData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...basePresenceData } as PresenceData;
    message.activities = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        ...
        case 3:
          message.maybePartialUser = {
            $case: "userId",
            userId: longToString(reader.fixed64() as Long),
          };
          break;
        case 4:
          ...
          break;
        case 5:
          message.clientStatus = PresenceData_PresenceClientStatusData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 6:
          message.activities.push(
            PresenceData_PresenceActivityData.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object: any): PresenceData {
    ...
    if (object.clientStatus !== undefined && object.clientStatus !== null) {
      message.clientStatus = PresenceData_PresenceClientStatusData.fromJSON(
        object.clientStatus
      );
    }
  ...
  toJSON(message: PresenceData): unknown {
    ...
    if (message.activities) {
      obj.activities = message.activities.map((e) =>
        e ? PresenceData_PresenceActivityData.toJSON(e) : undefined
      );
    } else {
      obj.activities = [];
    }
  ...
  fromPartial(object: DeepPartial<PresenceData>): PresenceData {
    ...
    if (
      object.maybePartialUser?.$case === "user" &&
    ...
    if (
      object.maybePartialUser?.$case === "userId" &&
    ...
    if (object.clientStatus !== undefined && object.clientStatus !== null) {
      message.clientStatus = PresenceData_PresenceClientStatusData.fromPartial(
        object.clientStatus
      );
    }
    if (object.activities !== undefined && object.activities !== null) {
      for (const e of object.activities) {
        message.activities.push(
          PresenceData_PresenceActivityData.fromPartial(e)
        );
      }
    }
    return message;
...
const basePresenceData_PresenceClientStatusData: object = {
  $type: "pylon.discord.v1.model.PresenceData.PresenceClientStatusData",
  desktop: "",
  mobile: "",
  web: "",
...
export const PresenceData_PresenceClientStatusData = {
  $type: "pylon.discord.v1.model.PresenceData.PresenceClientStatusData" as const,

  encode(
    message: PresenceData_PresenceClientStatusData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.desktop !== "") {
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): PresenceData_PresenceClientStatusData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...basePresenceData_PresenceClientStatusData,
    } as PresenceData_PresenceClientStatusData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<PresenceData_PresenceClientStatusData>
  ): PresenceData_PresenceClientStatusData {
    const message = {
      ...basePresenceData_PresenceClientStatusData,
    } as PresenceData_PresenceClientStatusData;
...
messageTypeRegistry.set(
  PresenceData_PresenceClientStatusData.$type,
  PresenceData_PresenceClientStatusData
);

const basePresenceData_PresenceActivityData: object = {
  $type: "pylon.discord.v1.model.PresenceData.PresenceActivityData",
  name: "",
  type: 0,
  url: "",
...
export const PresenceData_PresenceActivityData = {
  $type: "pylon.discord.v1.model.PresenceData.PresenceActivityData" as const,

  encode(
    message: PresenceData_PresenceActivityData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    ...
    if (message.timestamps !== undefined) {
      PresenceData_PresenceActivityData_PresenceActivityTimestampsData.encode(
        message.timestamps,
        writer.uint32(42).fork()
      ).ldelim();
    }
    ...
    if (message.emoji !== undefined) {
      PresenceData_PresenceActivityData_PresenceActivityEmojiData.encode(
        message.emoji,
        writer.uint32(74).fork()
      ).ldelim();
    }
    if (message.party !== undefined) {
      PresenceData_PresenceActivityData_PresenceActivityPartyData.encode(
        message.party,
        writer.uint32(82).fork()
      ).ldelim();
    }
    if (message.assets !== undefined) {
      PresenceData_PresenceActivityData_PresenceActivityAssetsData.encode(
        message.assets,
        writer.uint32(90).fork()
      ).ldelim();
    }
    if (message.secrets !== undefined) {
      PresenceData_PresenceActivityData_PresenceActivitySecretsData.encode(
        message.secrets,
        writer.uint32(98).fork()
      ).ldelim();
    }
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): PresenceData_PresenceActivityData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...basePresenceData_PresenceActivityData,
    } as PresenceData_PresenceActivityData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 4:
          ...
          break;
        case 5:
          message.timestamps = PresenceData_PresenceActivityData_PresenceActivityTimestampsData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 6:
          message.applicationId = longToString(reader.fixed64() as Long);
          break;
        case 7:
        ...
        case 8:
          ...
          break;
        case 9:
          message.emoji = PresenceData_PresenceActivityData_PresenceActivityEmojiData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 10:
          message.party = PresenceData_PresenceActivityData_PresenceActivityPartyData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 11:
          message.assets = PresenceData_PresenceActivityData_PresenceActivityAssetsData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 12:
          message.secrets = PresenceData_PresenceActivityData_PresenceActivitySecretsData.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): PresenceData_PresenceActivityData {
    ...
    if (object.timestamps !== undefined && object.timestamps !== null) {
      message.timestamps = PresenceData_PresenceActivityData_PresenceActivityTimestampsData.fromJSON(
        object.timestamps
      );
    }
    ...
    if (object.emoji !== undefined && object.emoji !== null) {
      message.emoji = PresenceData_PresenceActivityData_PresenceActivityEmojiData.fromJSON(
        object.emoji
      );
    }
    if (object.party !== undefined && object.party !== null) {
      message.party = PresenceData_PresenceActivityData_PresenceActivityPartyData.fromJSON(
        object.party
      );
    }
    if (object.assets !== undefined && object.assets !== null) {
      message.assets = PresenceData_PresenceActivityData_PresenceActivityAssetsData.fromJSON(
        object.assets
      );
    }
    if (object.secrets !== undefined && object.secrets !== null) {
      message.secrets = PresenceData_PresenceActivityData_PresenceActivitySecretsData.fromJSON(
        object.secrets
      );
    }
  ...
  toJSON(message: PresenceData_PresenceActivityData): unknown {
    ...
    message.timestamps !== undefined &&
      (obj.timestamps = message.timestamps
        ? PresenceData_PresenceActivityData_PresenceActivityTimestampsData.toJSON(
            message.timestamps
          )
        : undefined);
    ...
    message.emoji !== undefined &&
      (obj.emoji = message.emoji
        ? PresenceData_PresenceActivityData_PresenceActivityEmojiData.toJSON(
            message.emoji
          )
        : undefined);
    message.party !== undefined &&
      (obj.party = message.party
        ? PresenceData_PresenceActivityData_PresenceActivityPartyData.toJSON(
            message.party
          )
        : undefined);
    message.assets !== undefined &&
      (obj.assets = message.assets
        ? PresenceData_PresenceActivityData_PresenceActivityAssetsData.toJSON(
            message.assets
          )
        : undefined);
    message.secrets !== undefined &&
      (obj.secrets = message.secrets
        ? PresenceData_PresenceActivityData_PresenceActivitySecretsData.toJSON(
            message.secrets
          )
        : undefined);
  ...
  fromPartial(
    object: DeepPartial<PresenceData_PresenceActivityData>
  ): PresenceData_PresenceActivityData {
    const message = {
      ...basePresenceData_PresenceActivityData,
    } as PresenceData_PresenceActivityData;
    ...
    if (object.timestamps !== undefined && object.timestamps !== null) {
      message.timestamps = PresenceData_PresenceActivityData_PresenceActivityTimestampsData.fromPartial(
        object.timestamps
      );
    }
    if (object.applicationId !== undefined && object.applicationId !== null) {
    ...
    if (object.emoji !== undefined && object.emoji !== null) {
      message.emoji = PresenceData_PresenceActivityData_PresenceActivityEmojiData.fromPartial(
        object.emoji
      );
    }
    if (object.party !== undefined && object.party !== null) {
      message.party = PresenceData_PresenceActivityData_PresenceActivityPartyData.fromPartial(
        object.party
      );
    }
    if (object.assets !== undefined && object.assets !== null) {
      message.assets = PresenceData_PresenceActivityData_PresenceActivityAssetsData.fromPartial(
        object.assets
      );
    }
    if (object.secrets !== undefined && object.secrets !== null) {
      message.secrets = PresenceData_PresenceActivityData_PresenceActivitySecretsData.fromPartial(
        object.secrets
      );
    }
    if (object.instance !== undefined && object.instance !== null) {
...
messageTypeRegistry.set(
  PresenceData_PresenceActivityData.$type,
  PresenceData_PresenceActivityData
);

const basePresenceData_PresenceActivityData_PresenceActivityTimestampsData: object = {
  $type:
    "pylon.discord.v1.model.PresenceData.PresenceActivityData.PresenceActivityTimestampsData",
  start: "0",
  end: "0",
};

export const PresenceData_PresenceActivityData_PresenceActivityTimestampsData = {
  $type: "pylon.discord.v1.model.PresenceData.PresenceActivityData.PresenceActivityTimestampsData" as const,

  encode(
    message: PresenceData_PresenceActivityData_PresenceActivityTimestampsData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.start !== "0") {
  ...
  decode(
    ...
    } as PresenceData_PresenceActivityData_PresenceActivityTimestampsData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.end = longToString(reader.uint64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(
    object: DeepPartial<PresenceData_PresenceActivityData_PresenceActivityTimestampsData>
  ): PresenceData_PresenceActivityData_PresenceActivityTimestampsData {
    const message = {
      ...basePresenceData_PresenceActivityData_PresenceActivityTimestampsData,
    } as PresenceData_PresenceActivityData_PresenceActivityTimestampsData;
...
messageTypeRegistry.set(
  PresenceData_PresenceActivityData_PresenceActivityTimestampsData.$type,
  PresenceData_PresenceActivityData_PresenceActivityTimestampsData
);

const basePresenceData_PresenceActivityData_PresenceActivityEmojiData: object = {
  $type:
    "pylon.discord.v1.model.PresenceData.PresenceActivityData.PresenceActivityEmojiData",
  name: "",
  id: "0",
  animated: false,
};
...
export const PresenceData_PresenceActivityData_PresenceActivityEmojiData = {
  $type: "pylon.discord.v1.model.PresenceData.PresenceActivityData.PresenceActivityEmojiData" as const,

  encode(
    message: PresenceData_PresenceActivityData_PresenceActivityEmojiData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
  ...
  decode(
    ...
    } as PresenceData_PresenceActivityData_PresenceActivityEmojiData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<PresenceData_PresenceActivityData_PresenceActivityEmojiData>
  ): PresenceData_PresenceActivityData_PresenceActivityEmojiData {
    const message = {
      ...basePresenceData_PresenceActivityData_PresenceActivityEmojiData,
    } as PresenceData_PresenceActivityData_PresenceActivityEmojiData;
...
messageTypeRegistry.set(
  PresenceData_PresenceActivityData_PresenceActivityEmojiData.$type,
  PresenceData_PresenceActivityData_PresenceActivityEmojiData
);

const basePresenceData_PresenceActivityData_PresenceActivityPartyData: object = {
  $type:
    "pylon.discord.v1.model.PresenceData.PresenceActivityData.PresenceActivityPartyData",
  id: "",
  currentSize: "0",
  maxSize: "0",
};
...
export const PresenceData_PresenceActivityData_PresenceActivityPartyData = {
  $type: "pylon.discord.v1.model.PresenceData.PresenceActivityData.PresenceActivityPartyData" as const,

  encode(
    message: PresenceData_PresenceActivityData_PresenceActivityPartyData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(
    ...
    } as PresenceData_PresenceActivityData_PresenceActivityPartyData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.currentSize = longToString(reader.uint64() as Long);
          break;
        case 3:
          message.maxSize = longToString(reader.uint64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(
    object: DeepPartial<PresenceData_PresenceActivityData_PresenceActivityPartyData>
  ): PresenceData_PresenceActivityData_PresenceActivityPartyData {
    const message = {
      ...basePresenceData_PresenceActivityData_PresenceActivityPartyData,
    } as PresenceData_PresenceActivityData_PresenceActivityPartyData;
...
messageTypeRegistry.set(
  PresenceData_PresenceActivityData_PresenceActivityPartyData.$type,
  PresenceData_PresenceActivityData_PresenceActivityPartyData
);

const basePresenceData_PresenceActivityData_PresenceActivityAssetsData: object = {
  $type:
    "pylon.discord.v1.model.PresenceData.PresenceActivityData.PresenceActivityAssetsData",
  largeImage: "",
  largeText: "",
  smallImage: "",
  smallText: "",
...
export const PresenceData_PresenceActivityData_PresenceActivityAssetsData = {
  $type: "pylon.discord.v1.model.PresenceData.PresenceActivityData.PresenceActivityAssetsData" as const,

  encode(
    message: PresenceData_PresenceActivityData_PresenceActivityAssetsData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
  ...
  decode(
    ...
    } as PresenceData_PresenceActivityData_PresenceActivityAssetsData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<PresenceData_PresenceActivityData_PresenceActivityAssetsData>
  ): PresenceData_PresenceActivityData_PresenceActivityAssetsData {
    const message = {
      ...basePresenceData_PresenceActivityData_PresenceActivityAssetsData,
    } as PresenceData_PresenceActivityData_PresenceActivityAssetsData;
...
messageTypeRegistry.set(
  PresenceData_PresenceActivityData_PresenceActivityAssetsData.$type,
  PresenceData_PresenceActivityData_PresenceActivityAssetsData
);

const basePresenceData_PresenceActivityData_PresenceActivitySecretsData: object = {
  $type:
    "pylon.discord.v1.model.PresenceData.PresenceActivityData.PresenceActivitySecretsData",
  join: "",
  spectate: "",
  match: "",
};
...
export const PresenceData_PresenceActivityData_PresenceActivitySecretsData = {
  $type: "pylon.discord.v1.model.PresenceData.PresenceActivityData.PresenceActivitySecretsData" as const,

  encode(
    message: PresenceData_PresenceActivityData_PresenceActivitySecretsData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.join !== "") {
  ...
  decode(
    ...
    } as PresenceData_PresenceActivityData_PresenceActivitySecretsData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<PresenceData_PresenceActivityData_PresenceActivitySecretsData>
  ): PresenceData_PresenceActivityData_PresenceActivitySecretsData {
    const message = {
      ...basePresenceData_PresenceActivityData_PresenceActivitySecretsData,
    } as PresenceData_PresenceActivityData_PresenceActivitySecretsData;
...
messageTypeRegistry.set(
  PresenceData_PresenceActivityData_PresenceActivitySecretsData.$type,
  PresenceData_PresenceActivityData_PresenceActivitySecretsData
);

const baseWebhookData: object = {
  $type: "pylon.discord.v1.model.WebhookData",
  id: "0",
  channelId: "0",
  guildId: "0",
...
export const WebhookData = {
  $type: "pylon.discord.v1.model.WebhookData" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WebhookData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseWebhookData } as WebhookData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const InviteData = {
  $type: "pylon.discord.v1.model.InviteData" as const,
  ...
  encode(
    ...
    if (message.guild !== undefined) {
      InviteData_InviteGuildData.encode(
        message.guild,
        writer.uint32(18).fork()
      ).ldelim();
    }
    if (message.channel !== undefined) {
      InviteData_InviteChannelData.encode(
        message.channel,
        writer.uint32(26).fork()
      ).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): InviteData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseInviteData } as InviteData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.guild = InviteData_InviteGuildData.decode(
            reader,
            reader.uint32()
          );
          break;
        case 3:
          message.channel = InviteData_InviteChannelData.decode(
            reader,
            reader.uint32()
          );
          break;
        ...
        case 6:
          ...
          break;
        case 7:
          message.approximatePresenceCount = UInt32Value.decode(
            reader,
            reader.uint32()
          ).value;
          break;
        case 8:
          message.approximateMemberCount = UInt32Value.decode(
            reader,
            reader.uint32()
          ).value;
          break;
  ...
  fromJSON(object: any): InviteData {
    ...
    if (
      object.approximatePresenceCount !== undefined &&
      object.approximatePresenceCount !== null
    ) {
      message.approximatePresenceCount = Number(
        object.approximatePresenceCount
      );
    }
    if (
      object.approximateMemberCount !== undefined &&
  ...
  fromPartial(object: DeepPartial<InviteData>): InviteData {
    ...
    if (object.channel !== undefined && object.channel !== null) {
      message.channel = InviteData_InviteChannelData.fromPartial(
        object.channel
      );
    }
    if (object.inviter !== undefined && object.inviter !== null) {
...
const baseInviteData_InviteGuildData: object = {
  $type: "pylon.discord.v1.model.InviteData.InviteGuildData",
  id: "0",
  name: "",
  features: "",
...
export const InviteData_InviteGuildData = {
  $type: "pylon.discord.v1.model.InviteData.InviteGuildData" as const,

  encode(
    message: InviteData_InviteGuildData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.id !== "0") {
      writer.uint32(9).fixed64(message.id);
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): InviteData_InviteGuildData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseInviteData_InviteGuildData,
    } as InviteData_InviteGuildData;
    message.features = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<InviteData_InviteGuildData>
  ): InviteData_InviteGuildData {
    const message = {
      ...baseInviteData_InviteGuildData,
    } as InviteData_InviteGuildData;
...
messageTypeRegistry.set(
  InviteData_InviteGuildData.$type,
  InviteData_InviteGuildData
);

const baseInviteData_InviteChannelData: object = {
  $type: "pylon.discord.v1.model.InviteData.InviteChannelData",
  id: "0",
  name: "",
  type: 0,
...
export const InviteData_InviteChannelData = {
  $type: "pylon.discord.v1.model.InviteData.InviteChannelData" as const,

  encode(
    message: InviteData_InviteChannelData,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.id !== "0") {
      writer.uint32(9).fixed64(message.id);
  ...
  decode(
    input: _m0.Reader | Uint8Array,
    length?: number
  ): InviteData_InviteChannelData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseInviteData_InviteChannelData,
    } as InviteData_InviteChannelData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<InviteData_InviteChannelData>
  ): InviteData_InviteChannelData {
    const message = {
      ...baseInviteData_InviteChannelData,
    } as InviteData_InviteChannelData;
...
messageTypeRegistry.set(
  InviteData_InviteChannelData.$type,
  InviteData_InviteChannelData
);

const baseGuildBanData: object = {
  $type: "pylon.discord.v1.model.GuildBanData",
  reason: "",
};

export const GuildBanData = {
  $type: "pylon.discord.v1.model.GuildBanData" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GuildBanData {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseGuildBanData } as GuildBanData;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
